...
GPU_ID=$1
CALIB_DATA_DIR="./logs/calib_data_quarot_sq"  # the path to save your calib dataset

#CUDA_VISIBLE_DEVICES=$GPU_ID python t2v/scripts/probe_quarot.py $CFG --ckpt_path $CKPT_PATH --data_num 10 --outdir $CALIB_DATA_DIR --save_dir $CALIB_DATA_DIR \
...
--precompute_text_embeds ./t2v/utils_files/text_embeds.pth --quarot
